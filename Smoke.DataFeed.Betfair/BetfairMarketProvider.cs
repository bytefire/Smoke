...
namespace CompanyName.ProductName.Provider.Betfair
{
    public class BetfairMarketProvider : MarketProviderBase, IDisposable
    {
        ...
        public override List<EventType> GetAllEventTypes(string provider)
        {
            ...
            List<EventType> eventTypes = BetfairApi.Instance.GetAllEventTypes();
            return eventTypes;
        }
        ...
        public override List<Market> GetCricketMarkets(string provider)
        {
            if (string.IsNullOrEmpty(provider))
                throw new ArgumentNullException("provider", "provider is null");
            ...
            List<BetfairMarket> betfairMarkets = BetfairApi.Instance.GetCricketMarkets();
        ...
        public override bool PlaceBets(string provider, List<BetToPlace> betsToPlace)
        {
            if (string.IsNullOrEmpty(provider))
                throw new ArgumentNullException("provider", "provider is null");
            ...
            return BetfairApi.Instance.PlaceBets(betsToPlace);
        }
        ...
        /// <returns></returns>
        public override Dictionary<int, ExchangePrice> GetOddsIndexedByRunnerId(int marketId)
        {
